...
\fancyhead{}\fancyfoot{}
\fancyhead[R]{\fontDinLight {\small Ανάπτυξη εφαρμογής σε Low Code περιβάλλον: Σχεδιασμός Εφαρμογής για τον
Προγραμματισμό και την Παρακολούθηση Εργασιών}\hspace{5pt}\colorbox{darkgray}{\color{white}\fontDin\thepage}}
